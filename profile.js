/**
 * Title: profile.js
 * Javascript for profile.html, used to store data for displaying and interactions
 */
...
new Vue({
  ...
  data() {
    ...
    return {
      ...
      value: '', //User's name
      value3: '', //User's University
      themeSwitch: '', //value for switch
      active: '', //navigation
      user: '', //user information
      userInitial: '', //user's initials for name
      value7:'', //User's discipline
      bookmarks:[] //User's bookmark
